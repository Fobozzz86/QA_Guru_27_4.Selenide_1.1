...
public class SandboxTests {
  ...
  @Test
  void pageObject() { // У Алексея Виноградова есть доклад по PageObject
  ...
  void findAttributeByValue() {
    $("[name$=order]").click(); // кликаем на элемент у которого атрибут name: ^ - начинается с order, $ - заканчивается нв order
  }
